      ...
      {PRIMARY_STATISTICS.map((statistic, index) => (
        ...
        >
          ...
          >
            {
              (index == 0)? 
                <CovidView label="Confirmados" number={dataCovid.confirmed} color="#fff !important" /> 
                : 
                  (index == 1) ? 
                    <CovidView label="Activos" number={dataCovid.active} /> 
                    : 
                      (index == 2) ? 
                        <CovidView label="Recuperados" number={dataCovid.recovered} /> 
                          : (index == 3) ? 
                            <CovidView label="Falecidos" number={dataCovid.deceased} /> : ""
            }
        </animated.div>
